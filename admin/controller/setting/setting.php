...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if ($this->request->server['HTTPS']) {
			$data['store_url'] = HTTPS_WEBSITE;
		} else {
			$data['store_url'] = HTTP_WEBSITE;
		}
	...
	public function theme() {
		...
		if (is_file(DIR_WEBSITE . 'view/theme/' . $theme . '/image/' . $theme . '.png')) {
			$this->response->setOutput($server . 'project/view/theme/' . $theme . '/image/' . $theme . '.png');
		} else {
